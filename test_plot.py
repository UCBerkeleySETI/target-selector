...
def test_plot():
    ...
    ax.scatter(shifted_contours_ra, shifted_contours_decl, s=0.00000001, marker=",", color='green', linewidths=0.1)
    ax.scatter(shifted_ellipses_ra, shifted_ellipses_decl, s=0.00000001, marker=",", color='red', linewidths=0.1)
    # ax.scatter(shifted_contours_ra, shifted_contours_decl, s=0.00000001, marker=",", color='green')
    # ax.scatter(shifted_ellipses_ra, shifted_ellipses_decl, s=0.00000001, marker=",", color='red')
